 ...
 *
 * Last modified 2017-05-04 19:05:13
 *
...
package com.github.guodongandroid.recyclerview.adapter.multitype;
...
import com.github.guodongandroid.recyclerview.adapter.typepool.MultiTypePool;
import com.github.guodongandroid.recyclerview.adapter.typepool.TypePool;
...
//        }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        provider.onBindView(holder, position, item);
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position, List<Object> payloads) {
        if (payloads.isEmpty()) {
            ...
            Object item = mItems.get(position);
            BaseViewProvider provider = getProviderByClass(item.getClass());
            provider.onBindView(holder, position, item, payloads);
        }
    }
